...
# --- All configuration, model download, and patching logic has been moved to setup_magic_pdf.py ---
# --- All extraction logic has been moved to extractor.py ---
...
# Load latex_delimiters and language lists from mineru_config.json
with open("mineru_config.json", "r", encoding="utf-8") as f:
    mineru_config = json.load(f)
latex_delimiters = mineru_config["latex_delimiters"]
languages = mineru_config["languages"]
all_lang = []
all_lang.extend(languages["other_lang"] + languages["add_lang"])
